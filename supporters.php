...
$URL = 'https://utcatholic.givecloud.co/admin/api/v2/supporters';
...
$supporters = getData($total_pages,$page,$URL,$Headers);

$count = 0;
foreach(array_values($supporters) as $row){
    $count++;
    ...
    $status = mysqli_real_escape_string($conn,$row->active);
        ...
        $insertquery = "INSERT INTO `supporters` (supporter_id,first_name,last_name,email,status) 
